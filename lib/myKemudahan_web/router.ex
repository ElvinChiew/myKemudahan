defmodule MyKemudahanWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MyKemudahanWeb.Layouts, :root}
  ...
  # scope "/api", MyKemudahanWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:myKemudahan, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MyKemudahanWeb.Telemetry
  ...
  scope "/", MyKemudahanWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MyKemudahanWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MyKemudahanWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MyKemudahanWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", MyKemudahanWeb do
    ...
    live_session :current_user,
      on_mount: [{MyKemudahanWeb.UserAuth, :mount_current_user}] do
