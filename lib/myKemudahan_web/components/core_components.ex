defmodule MyKemudahanWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: MyKemudahanWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-teal-500 hover:bg-teal-300 py-2 px-3",
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-200 sm:text-sm sm:leading-6",
          @errors == [] && "border-zinc-300 focus:border-zinc-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MyKemudahanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MyKemudahanWeb.Gettext, "errors", msg, opts)
    end
  end
