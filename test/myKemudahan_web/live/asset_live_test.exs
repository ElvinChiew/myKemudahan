defmodule MyKemudahanWeb.AssetLiveTest do
  use MyKemudahanWeb.ConnCase

  import Phoenix.LiveViewTest
  import MyKemudahan.AssetsFixtures

  @create_attrs %{name: "some name", status: "some status", description: "some description", image: "some image", cost_per_unit: "120.5"}
